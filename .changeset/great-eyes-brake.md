...
A collection's list could be narrowed by status, author, byline, date range, free text and any indexed custom field, but not by a taxonomy term — so a site organised by categories or tags could not be browsed by them in the screen editors work in.
